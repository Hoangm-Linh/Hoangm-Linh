...
### 🏦 [Quản lý Ngân hàng Mini](https://github.com/Hoangm-Linh/LTM-He-Thong-Quan-Ly-Ngan-Hang-Mini)

Hệ thống ngân hàng mini Client–Server: quản lý khách hàng, tài khoản, nạp/rút/chuyển, sao kê, phân quyền và tìm kiếm dữ liệu qua TCP.
...
<img src="https://img.shields.io/badge/TCP-38bdf8?style=flat-square" alt="TCP" />
...
Web quản lý hành chính xã: dân cư, hộ gia đình, giấy tờ, phản hồi người dân; phân quyền và phân loại phản hồi bằng Machine Learning.
...
### 🔐 [ATBMTT — Cloud Simulator](https://github.com/Hoangm-Linh/ATBMTT)

Hệ thống upload/download file tách Server/Client; mã hóa AES-GCM, trao đổi khóa RSA và giao thức Socket TCP bảo mật end-to-end.
...
**Công nghệ:**
<img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" alt="Python" />
<img src="https://img.shields.io/badge/AES--GCM-38bdf8?style=flat-square" alt="AES-GCM" />
<img src="https://img.shields.io/badge/RSA-2563EB?style=flat-square" alt="RSA" />
<img src="https://img.shields.io/badge/Socket-181717?style=flat-square" alt="Socket" />
...
Phân tích dữ liệu chuyến đi taxi New York City: xử lý big data với Spark, trực quan hóa xu hướng và dự đoán chi phí bằng hồi quy tuyến tính.
...
<img src="https://img.shields.io/badge/Big_Data-0ea5e9?style=flat-square" alt="Big Data" />
...
Hệ thống điểm danh sinh viên tích hợp Arduino (LED, còi) + Python, MongoDB, Flask; gửi mã QR qua email và xuất báo cáo CSV.
